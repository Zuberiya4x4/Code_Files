#debit amount missing, remitter to beneficiary info missing
import json
...
def main():
    ...
    file_path = r"C:\Users\SyedaZuberiya\Desktop\PyMuPDF Testing\Payment_Advice_F1.pdf"  # Replace with your PDF path
